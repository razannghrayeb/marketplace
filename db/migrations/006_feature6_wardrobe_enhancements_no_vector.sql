-- Migration: 006_feature6_wardrobe_enhancements.sql (PATCHED - no pgvector dependency)
...
CREATE TABLE IF NOT EXISTS wardrobe_item_analysis_cache (
    ...
    embedding_vector TEXT,                    -- CLIP embedding as JSON array (stored as text, not pgvector)
