...
const CATEGORY_DATA: Array<{
  ...
  { name: "outerwear", aliases: ["jacket", "jackets", "coat", "coats", "blazer", "blazers", "cardigan", "cardigans", "parka", "windbreaker", "vest", "gilet", "trench", "poncho", "suit", "suits", "tuxedo", "tuxedos", "sport coat", "dress jacket"], arabic: "جاكيتات", arabizi: "jaketaat", popularity: 0.82 },
