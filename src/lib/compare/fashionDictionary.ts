...
export interface OccasionEntry {
  ...
  arabic: string[];
  arabizi: string[];
  formality: "formal" | "semi-formal" | "casual" | "active";
}
...
export const CARE_INSTRUCTIONS: CareEntry[] = [
  { 
...
// ============================================================================
// Red Flag Words (Risky Marketing Indicators)
// ============================================================================
...
export const SIZE_ARABIC_PATTERNS: RegExp[] = [
  /\bمقاس\s*\d+/,
  /\bقياس\s*\d+/,
...
export const RETURN_POLICY_KEYWORDS = {
  english: [
...
// ============================================================================
// Utility: Build lookup maps for fast matching
// ============================================================================

export interface LookupMaps {
  fabricMap: Map<string, { canonical: string; quality_tier: string }>;
  fitMap: Map<string, string>;
  occasionMap: Map<string, { canonical: string; formality: string }>;
  careMap: Map<string, string>;
  redFlagMap: Map<string, { severity: string; reason: string }>;
}

let _lookupMaps: LookupMaps | null = null;

export function buildLookupMaps(): LookupMaps {
  if (_lookupMaps) return _lookupMaps;

  const fabricMap = new Map<string, { canonical: string; quality_tier: string }>();
  ...
  const occasionMap = new Map<string, { canonical: string; formality: string }>();
