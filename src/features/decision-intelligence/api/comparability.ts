...
const MAJOR_CATEGORY_TOKENS: Array<{ token: string; major: string }> = [
  ...
  { token: "suit jacket", major: "tailored" },
  { token: "dress jacket", major: "tailored" },
  { token: "waistcoat", major: "tailored" },
  { token: "gilet", major: "tailored" },
  { token: "vest", major: "tailored" },
  { token: "tailored jacket", major: "tailored" },
  { token: "structured jacket", major: "tailored" },
  { token: "suit", major: "tailored" },
  { token: "tuxedo", major: "tailored" },
...
const CATEGORY_COMPATIBILITY: Record<string, Set<string>> = {
  ...
  tailored: new Set(["tailored", "outerwear", "tops", "bottoms", "one_piece", "accessories"]),
