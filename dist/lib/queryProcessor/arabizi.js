...
exports.FASHION_ARABIZI = void 0;
exports.isArabicChar = isArabicChar;
exports.isLatinChar = isLatinChar;
exports.hasArabiziPattern = hasArabiziPattern;
exports.detectScript = detectScript;
exports.arabiziToArabic = arabiziToArabic;
exports.arabicToArabizi = arabicToArabizi;
exports.normalizeArabic = normalizeArabic;
exports.getTransliterationVariants = getTransliterationVariants;
exports.expandFashionTerm = expandFashionTerm;
// ============================================================================
// Character Mappings
// ============================================================================
/**
 ...
 */
const ARABIZI_WORD_MAP = new Map([
 ...
 */
function hasArabiziPattern(text) {
 ...
 */
function getTransliterationVariants(text) {
 ...
 */
exports.FASHION_ARABIZI = new Map([
    // Clothing items
 ...
 */
function expandFashionTerm(term) {
    const normalized = term.toLowerCase().trim();
    if (exports.FASHION_ARABIZI.has(normalized)) {
        return exports.FASHION_ARABIZI.get(normalized);
    }
    ...
    if (exports.FASHION_ARABIZI.has(withNumbers)) {
        return exports.FASHION_ARABIZI.get(withNumbers);
    }
    return null;
}
