...
exports.rewriteWithLLM = rewriteWithLLM;
...
// Prompt Templates
// ============================================================================
function buildSystemPrompt(allowedBrands, allowedCategories, allowedGenders) {
 ...
 */
async function rewriteWithLLM(request) {
    const llmConfig = getLLMConfig();
    if (llmConfig.provider === "none") {
        return null;
    }
    const systemPrompt = buildSystemPrompt(request.allowedBrands, request.allowedCategories, request.allowedGenders);
 ...
 */
function shouldUseLLM(query, script, hasRuleCorrection, ruleConfidence) {
