...
exports.LLM_PROMPT_TEMPLATE = void 0;
exports.generateVerdict = generateVerdict;
exports.getReasonTooltip = getReasonTooltip;
exports.getAllReasonTemplates = getAllReasonTemplates;
 ...
 */
function generateHighlights(comparison) {
    const highlights = [];
 ...
 */
function generateConcerns(comparison) {
    const concerns = [];
    const { signals } = comparison;
 ...
 */
function generateTooltips(comparison) {
    const tooltips = {};
 ...
 */
function generateProductSummary(comparison) {
    return {
 ...
 */
function generateVerdict(verdict, productLetters = new Map() // Map product IDs to letters (A, B, C...)
) {
 ...
 */
function getAllReasonTemplates() {
 ...
 */
function formatForLLM(verdict, winnerLetter) {
