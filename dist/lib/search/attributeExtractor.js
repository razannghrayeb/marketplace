...
async function initML() {
    ...
    mlInitPromise = (async () => {
        try {
            ...
            pipeline = await createPipeline("zero-shot-classification", "Xenova/mobilebert-uncased-mnli", { quantized: true });
            mlInitialized = true;
 ...
 */
async function extractWithML(normalizedTitle, missingAttributes, threshold = 0.7) {
    const attributes = {};
    const confidence = {};
 ...
 */
async function extractAttributes(title, options = {}) {
